...
Foam::IOPositionOld<CloudType>::IOPositionOld(const CloudType& c)
:
    regIOobject
    (
        IOobject
...
template<class CloudType>
bool Foam::IOPositionOld<CloudType>::write(const bool valid) const
{
...
template<class CloudType>
bool Foam::IOPositionOld<CloudType>::writeData(Ostream& os) const
{
